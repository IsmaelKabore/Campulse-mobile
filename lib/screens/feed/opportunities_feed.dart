...
class OpportunitiesFeed extends StatefulWidget {
  const OpportunitiesFeed({super.key});
...
class _OpportunitiesFeedState extends State<OpportunitiesFeed> {
  ...
  void initState() {
    ...
    WidgetsBinding.instance.addPostFrameCallback((_) {
      context.read<PostProvider>().loadPostsByCategory(PostCategory.opportunities);
    });
  }
          ...
          SliverPadding(
            ...
            sliver: Consumer<PostProvider>(
              builder: (context, postProvider, _) {
                if (postProvider.isLoading && postProvider.opportunities.isEmpty) {
                  return const SliverFillRemaining(
                    child: AppLoadingState(),
                  );
                }

                if (postProvider.error != null && postProvider.opportunities.isEmpty) {
                ...
                if (postProvider.opportunities.isEmpty) {
                  return const SliverFillRemaining(
                    child: AppEmptyState(
                ...
                return SliverGrid(
                  ...
                  delegate: SliverChildBuilderDelegate(
                    (context, index) {
                      final post = postProvider.opportunities[index];
                      return EventCard(
                        post: post,
                        onTap: () {
                          Navigator.push(
                    ...
                    childCount: postProvider.opportunities.length,
                  ),
                );
              },
            ),
